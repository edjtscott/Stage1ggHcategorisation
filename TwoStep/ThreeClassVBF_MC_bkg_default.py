...
from addRowFunctions import truthProcess, ProcessWeight
...
plt.hist((BDTPredYtrain[:,1])[(BDTTrainY==2)],bins=50,weights=BDTTrainFW[(BDTTrainY==2)], histtype='step',normed=1, color='blue',label='bkg', range = [0.,1.])
...
plt.hist((BDTPredYtrain[:,1])[(BDTTrainY==1)],bins=50,weights=BDTTrainFW[(BDTTrainY==1)], histtype='step',normed=1, color='green',label='vbf',range = [0.,1.])
...
plt.hist((BDTPredYtest[:,1])[(BDTTestY==2)],weights=BDTTestFW[(BDTTestY==2)], histtype='step',normed=1, color='blue',label='bkg',range = [0.,1.],bins=50)
...
plt.hist((BDTPredYtest[:,1])[(BDTTestY==1)],weights=BDTTestFW[(BDTTestY==1)], histtype='step',normed=1, color='green',label='vbf',range = [0.,1.],bins=50)
...
plt.hist((BDTPredYtrain[:,0])[(BDTTrainY==2)],bins=50,weights=BDTTrainFW[(BDTTrainY==2)], histtype='step',normed=1, color='blue',label='bkg',range = [0.,1.])
...
plt.hist((BDTPredYtrain[:,2])[(BDTTrainY==2)],bins=50,weights=BDTTrainFW[(BDTTrainY==2)], histtype='step',normed=1, color='blue',label='bkg',range = [0.,1.])
plt.hist((BDTPredYtrain[:,2])[(BDTTrainY==0)],bins=50,weights=BDTTrainFW[(BDTTrainY==0)], histtype='step',normed=1, color='red',label='ggh',range = [0.,1.])
plt.hist((BDTPredYtrain[:,2])[(BDTTrainY==1)],bins=50,weights=BDTTrainFW[(BDTTrainY==1)], histtype='step',normed=1, color='green',label='vbf',range = [0.,1.])
...
plt.hist((BDTPredYtest[:,2])[(BDTTestY==2)],weights=BDTTestFW[(BDTTestY==2)], histtype='step',normed=1, color='blue',label='bkg',range = [0.,1.], bins=50)
plt.hist((BDTPredYtest[:,2])[(BDTTestY==0)],weights=BDTTestFW[(BDTTestY==0)], histtype='step',normed=1, color='red',label='ggh',range = [0.,1.],bins = 50)
plt.hist((BDTPredYtest[:,2])[(BDTTestY==1)],weights=BDTTestFW[(BDTTestY==1)], histtype='step',normed=1, color='green',label='vbf',range = [0.,1.], bins=50)
...
for cutVal in cutVal_list:#BDT boundaries--we are using 3 VH tag categories?
  ...
  selectedbkg = testScale * np.sum( BDTTestFW * (BDTTestY==2) * ((BDTPredYtest[:,1])>cutVal) )

  selectedbkg_exp = BDTTestM[(BDTTestY==2)&((BDTPredYtest[:,1])>cutVal)]
  selectedbkg_exp_w = BDTTestFW[(BDTTestY==2)&((BDTPredYtest[:,1])>cutVal)]
...
selectedbkg = testScale * np.sum( BDTTestFW * (BDTTestY==2) * (BDTPredClassTest==1))
selectedbkg_perGeV = selectedbkg/70.
selectedtotal = selectedvbf+selectedggh+selectedbkg
...
selectedbkg = testScale * np.sum( BDTTestFW * (BDTTestY==2) * (BDTPredClassTest==0))
...
selectedbkg = testScale * np.sum( BDTTestFW * (BDTTestY==2) * (BDTPredClassTest==2))
