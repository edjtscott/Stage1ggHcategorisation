...
#adding variables that need to be calculated
  ...
  dataTotal['dijet_dipho_dEta']=((dataTotal.dijet_leadEta+dataTotal.dijet_subleadEta)/2)-((dataTotal.dipho_leadEta+dataTotal.dipho_subleadEta)/2)
...
optimiser = CatOptim(sigWeights, vhHadM, [vhHadV,vhHadD], bkgWeights, dataM, [dataV,dataD], 1, ranges, names)
